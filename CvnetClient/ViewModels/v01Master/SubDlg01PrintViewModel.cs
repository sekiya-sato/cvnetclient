...
namespace CvnetClient.ViewModels
{
    public partial class SubDlg01PrintViewModel : BaseViewModel
    {
        ...
        {           
            ...
            var list = (from DataRow dr in ret_data.Rows
                        select new MasterManagePrt
                        {
                            ...
                            Item01 = dr["項目01"].ToString() ?? string.Empty,
                            Item02 = dr["項目02"].ToString() ?? string.Empty,
                            Item03 = dr["項目03"].ToString() ?? string.Empty,
                            Item04 = dr["項目04"].ToString() ?? string.Empty,
                            Item05 = dr["項目05"].ToString() ?? string.Empty,
                            Item06 = dr["項目06"].ToString() ?? string.Empty,
                            Item07 = dr["項目07"].ToString() ?? string.Empty,
                            Item08 = dr["項目08"].ToString() ?? string.Empty,
                            Item09 = dr["項目09"].ToString() ?? string.Empty,
                            Item10 = dr["項目10"].ToString() ?? string.Empty,
                            Item11 = dr["項目11"].ToString() ?? string.Empty,
                            Item12 = dr["項目12"].ToString() ?? string.Empty,
                            Item13 = dr["項目13"].ToString() ?? string.Empty,
                            Item14 = dr["項目14"].ToString() ?? string.Empty,
                            Item15 = dr["項目15"].ToString() ?? string.Empty,
                            Item16 = dr["項目16"].ToString() ?? string.Empty,
                            Item17 = dr["項目17"].ToString() ?? string.Empty,
                            Item18 = dr["項目18"].ToString() ?? string.Empty,
                            Item19 = dr["項目19"].ToString() ?? string.Empty,
                            Item20 = dr["項目20"].ToString() ?? string.Empty,
                            Item21 = dr["項目21"].ToString() ?? string.Empty,
                            Item22 = dr["項目22"].ToString() ?? string.Empty,
                            Item23 = dr["項目23"].ToString() ?? string.Empty,
                            Item24 = dr["項目24"].ToString() ?? string.Empty,
                            Item25 = dr["項目25"].ToString() ?? string.Empty,
                            Item26 = dr["項目26"].ToString() ?? string.Empty,
                            Item27 = dr["項目27"].ToString() ?? string.Empty,
                            Item28 = dr["項目28"].ToString() ?? string.Empty,
                            Item29 = dr["項目29"].ToString() ?? string.Empty,
                            Item30 = dr["項目30"].ToString() ?? string.Empty,
                            Item31 = dr["項目31"].ToString() ?? string.Empty,
                            Item32 = dr["項目32"].ToString() ?? string.Empty,
                            Item33 = dr["項目33"].ToString() ?? string.Empty,
                            Item34 = dr["項目34"].ToString() ?? string.Empty,
                            Item35 = dr["項目35"].ToString() ?? string.Empty,
                            Item36 = dr["項目36"].ToString() ?? string.Empty,
                            Item37 = dr["項目37"].ToString() ?? string.Empty,
                            Item38 = dr["項目38"].ToString() ?? string.Empty,
                            Item39 = dr["項目39"].ToString() ?? string.Empty,
                            Item40 = dr["項目40"].ToString() ?? string.Empty,
                            Item41 = dr["項目41"].ToString() ?? string.Empty,
                            Item42 = dr["項目42"].ToString() ?? string.Empty,
                            Item43 = dr["項目43"].ToString() ?? string.Empty,
                            Item44 = dr["項目44"].ToString() ?? string.Empty,
                            Item45 = dr["項目45"].ToString() ?? string.Empty,
                            Item46 = dr["項目46"].ToString() ?? string.Empty,
                            Item47 = dr["項目47"].ToString() ?? string.Empty,
                            Item48 = dr["項目48"].ToString() ?? string.Empty,
                            Item49 = dr["項目49"].ToString() ?? string.Empty,
                            Item50 = dr["項目50"].ToString() ?? string.Empty,
                            Item51 = dr["項目51"].ToString() ?? string.Empty,
                            Item52 = dr["項目52"].ToString() ?? string.Empty,
                            Item53 = dr["項目53"].ToString() ?? string.Empty,
                            Item54 = dr["項目54"].ToString() ?? string.Empty,
                            Item55 = dr["項目55"].ToString() ?? string.Empty,
                            Item56 = dr["項目56"].ToString() ?? string.Empty,
                            Item57 = dr["項目57"].ToString() ?? string.Empty,
                            Item58 = dr["項目58"].ToString() ?? string.Empty,
                            Item59 = dr["項目59"].ToString() ?? string.Empty,
                            Item60 = dr["項目60"].ToString() ?? string.Empty,
                            Item61 = dr["項目61"].ToString() ?? string.Empty,
                            Item62 = dr["項目62"].ToString() ?? string.Empty,
                            Item63 = dr["項目63"].ToString() ?? string.Empty,
                            Item64 = dr["項目64"].ToString() ?? string.Empty,
                            Item65 = dr["項目65"].ToString() ?? string.Empty,
                            Item66 = dr["項目66"].ToString() ?? string.Empty,
                            Item67 = dr["項目67"].ToString() ?? string.Empty,
                            Item68 = dr["項目68"].ToString() ?? string.Empty,
                            Item69 = dr["項目69"].ToString() ?? string.Empty,
                            Item70 = dr["項目70"].ToString() ?? string.Empty,
                            Item71 = dr["項目71"].ToString() ?? string.Empty,
                            Item72 = dr["項目72"].ToString() ?? string.Empty,
                            Item73 = dr["項目73"].ToString() ?? string.Empty,
                            Item74 = dr["項目74"].ToString() ?? string.Empty,
                            Item75 = dr["項目75"].ToString() ?? string.Empty,
                            Item76 = dr["項目76"].ToString() ?? string.Empty,
                            Item77 = dr["項目77"].ToString() ?? string.Empty,
                            Item78 = dr["項目78"].ToString() ?? string.Empty,
                            Item79 = dr["項目79"].ToString() ?? string.Empty,
                            Item80 = dr["項目80"].ToString() ?? string.Empty,
                            Item81 = dr["項目81"].ToString() ?? string.Empty,
                            Item82 = dr["項目82"].ToString() ?? string.Empty,
                            Item83 = dr["項目83"].ToString() ?? string.Empty,
                            Item84 = dr["項目84"].ToString() ?? string.Empty,
                            Item85 = dr["項目85"].ToString() ?? string.Empty,
                            Item86 = dr["項目86"].ToString() ?? string.Empty,
                            Item87 = dr["項目87"].ToString() ?? string.Empty,
                            Item88 = dr["項目88"].ToString() ?? string.Empty,
                            Item89 = dr["項目89"].ToString() ?? string.Empty,
                            Item90 = dr["項目90"].ToString() ?? string.Empty,
        ...
        void DoUpdate()
        {
            ...
            Common.ConvertDotStringAdd(item);
            if (item == null) return;
            var ret = AppData.Http!.AspxSqlExe(DBDef.DB_DML.UPDATE, "Master_PRT_KANRI", item.SeqNo, VDateHelper.ToVDate(DateTime.Now).ToString(),
                new string[] { "帳票CD","QFM名","メニュー名","帳票名","項目01","項目02","項目03","項目04","項目05","項目06","項目07","項目08","項目09項目10","項目11","項目12","項目13","項目14","項目15","項目16","項目17","項目18","項目19","項目20","項目21","項目22","項目23","項目24","項目25","項目26","項目27","項目28","項目29","項目30","項目31","項目32","項目33","項目34","項目35","項目36","項目37","項目38","項目39","項目40","項目41","項目42","項目43","項目44","項目45","項目46","項目47","項目48","項目49","項目50","項目51","項目52","項目53","項目54","項目55","項目56","項目57","項目58","項目59","項目60","項目61","項目62","項目63","項目64","項目65","項目66","項目67","項目68","項目69","項目70","項目71","項目72","項目73","項目74","項目75","項目76","項目77","項目78","項目79","項目80","項目81","項目82","項目83","項目84","項目85","項目86","項目87","項目88","項目89","項目90","入力社員CD"},
                new string[] { item.FormCD, item.QfmName, item.MenuName, item.FormName, item.Item01, item.Item02, item.Item03, item.Item04, item.Item05, item.Item06, item.Item07, item.Item08, item.Item09, item.Item10, item.Item11, item.Item12, item.Item13, item.Item14, item.Item15, item.Item16, item.Item17, item.Item18, item.Item19, item.Item20, item.Item21, item.Item22, item.Item23, item.Item24, item.Item25, item.Item26, item.Item27, item.Item28, item.Item29, item.Item30, item.Item31, item.Item32, item.Item33, item.Item34, item.Item35, item.Item36, item.Item37, item.Item38, item.Item39, item.Item40, item.Item41, item.Item42, item.Item43, item.Item44, item.Item45, item.Item46, item.Item47, item.Item48, item.Item49, item.Item50, item.Item51, item.Item52, item.Item53, item.Item54, item.Item55, item.Item56, item.Item57, item.Item58, item.Item59, item.Item60, item.Item61, item.Item62, item.Item63, item.Item64, item.Item65, item.Item66, item.Item67, item.Item68, item.Item69, item.Item70, item.Item71, item.Item72, item.Item73, item.Item74, item.Item75, item.Item76, item.Item77, item.Item78, item.Item79, item.Item80, item.Item81, item.Item82, item.Item83, item.Item84, item.Item85, item.Item86, item.Item87, item.Item88, item.Item89, item.Item90, item.InpEmployeeCD });
            if (ret.Code == 0)
            {
